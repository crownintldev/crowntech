...
const Blog = () => {
  ...
  return (
    ...
    <Button className={'bg-primary-black text-primary-white'} text="View more" />
    </div>
    <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3'>
      {
        Blogdata.map((array , index)=>(
          ...
          <div className={`w-9/12 flex justify-center p-3 rounded-lg shadow-xl bg-primary-light `}>
            <Image className=' hover:scale-105 duration-500 transition rounded-md object-cover' src={array.image} alt={array.image} />
            </div>
          </div>
            <div className={`p-4 relative  shadow-2xl space-y-3 rounded-lg pt-10 bg-primary-black`}>
            ...
            <Button className='border-none px-4 py-2 bg-gradient-to-r from-primary-btn1 hover:from-primary-btn3 via-primary-btn2 to-primary-btn3 hover:to-primary-btn1 text-primary-black transition duration-400 shadow-md' text={'Read More'}/>
            </div>
