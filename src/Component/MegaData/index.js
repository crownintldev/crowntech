        ...
        <>
          ...
          {services.length > 0 && services.map((service, index) => (
            <div
              ...
              className="flex flex-colh-full w-full  sm:flex-row border md:border-none mt-2 md:mt-0 mb-3 md:mb-0 duration-300 transition gap-3 rounded-md hover:bg-primary-blue300 text-primary-white hover:text-primary-black px-2 py-2 cursor-pointer"
            >
              <div>
